...
export const GAS_FEE_IN_ATOMIC_UNITS = "300000000000000";
export const NO_DEPOSIT = "0";

// Constants for calculateSizeOfData
export const ESTIMATED_KEY_VALUE_SIZE = 40;
export const ESTIMATED_NODE_SIZE = 40;
